...
const ContactDeveloper = () => {
    ...
    const whatsappNumber = "923022111051";
    const message = "iam getting deficulty in login in";
            ...
            <Card className="w-full max-w-md shadow-lg text-center">
                ...
                <CardContent className="space-y-6">
                    <p className="text-gray-600">
                        Only administrators are allowed to log in. If you believe this is an error, please contact the developer.
                    </p>
                    ...
                    <Button variant="outline" onClick={handleLogout} className="w-full flex gap-2">
